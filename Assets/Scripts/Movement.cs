...
namespace Sneakers
{
    public class Movement : MonoBehaviour
    {
        ...
        GameObject InstantiateSneaker()
        {
            ...
            SneakerModel sneaker = obj.AddComponent<SneakerModel>();
        ...
        IEnumerator Spawn()
        {
            while(true)
            {
                ...
                if(obj != null)
                {
                    obj.GetComponent<SneakerModel>().route = StartCoroutine(MainRoute(obj, 0));
        ...
        public IEnumerator MainRoute(GameObject obj, int mover)
        {
            ...
            obj.GetComponent<SneakerModel>().route_index = 0;
            if (mover == 0)
            {
                obj.GetComponent<SneakerModel>().currentPoint = 0;
            ...
            if (mover == 1)
            {
                ...
                {
                    obj.GetComponent<SneakerModel>().currentPoint = 1;
            ...
            if (mover == 2)
            {
                obj.GetComponent<SneakerModel>().currentPoint = 2;
            ...
            if(mover == 3)
            {
                obj.GetComponent<SneakerModel>().currentPoint = 3;
                if(obj.GetComponent<SneakerModel>().state == 4)
                {
        ...
        {
            obj.GetComponent<SneakerModel>().route_index = 1;
            obj.GetComponent<DragDropItem>().isDropped = false;
            if (mover == 2)
            {
                obj.GetComponent<SneakerModel>().currentPoint = 2;
            ...
            if (mover == 3)
            {
                ...
                obj.GetComponent<SneakerModel>().state = 1;
                obj.GetComponent<SneakerModel>().Sprite = sneakers[obj.GetComponent<SneakerModel>().Id].Sprite;
                obj.GetComponent<Image>().sprite = sneakers[obj.GetComponent<SneakerModel>().Id].Sprite;
                obj.GetComponent<SneakerModel>().currentPoint = 3;
            ...
            if (mover == 4)
            {
                obj.GetComponent<SneakerModel>().currentPoint = 4;
            ...
            if (mover == 5)
            {
                obj.GetComponent<SneakerModel>().currentPoint = 5;
                obj.GetComponent<SneakerModel>().route = StartCoroutine(MainRoute(obj, 0));
            }
        }
        ...
        {
            obj.GetComponent<DragDropItem>().isDropped = false;
            obj.GetComponent<SneakerModel>().route_index = 2;
            if (mover == 2)
            {
        ...
        public IEnumerator WaitRoute(GameObject obj, int mover)
        {
            if (mover == 1)
            {
                ...
                StopCoroutine(obj.GetComponent<SneakerModel>().route);
                Debug.Log("stopped");
            }
            if (mover == 2)
            {
