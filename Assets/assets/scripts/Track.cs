            ...
            switch (id)
            {
                ...
                case 3:
                    if (!eventData.pointerDrag.GetComponent<DragDropItem>().isHold)
                    {
                        ...
                        eventData.pointerDrag.GetComponent<SneakerScript>().route = StartCoroutine(movement.MainRoute(eventData.pointerDrag.gameObject, eventData.pointerDrag.GetComponent<SneakerScript>().currentPoint));
                    }
                    if (eventData.pointerDrag.GetComponent<DragDropItem>().isHold)
                    {
                        eventData.pointerDrag.transform.position = eventData.pointerDrag.GetComponent<DragDropItem>().vector;
                ...
                case 4:
                    if (!eventData.pointerDrag.GetComponent<DragDropItem>().isHold)
                    {
                        if (eventData.pointerDrag.GetComponent<SneakerScript>().state == 2)
                        {
                            ...
                            eventData.pointerDrag.GetComponent<SneakerScript>().route = StartCoroutine(movement.WashRoute(eventData.pointerDrag.gameObject, 2));
                        }
                        else
                        {
                            eventData.pointerDrag.transform.position = eventData.pointerDrag.GetComponent<DragDropItem>().vector;
                ...
                case 5:
                    if (!eventData.pointerDrag.GetComponent<DragDropItem>().isHold)
                    {
                        if (eventData.pointerDrag.GetComponent<SneakerScript>().state == 3)
                        {
                            eventData.pointerDrag.transform.position = movement.points[7].position;
                            eventData.pointerDrag.GetComponent<SneakerScript>().route = StartCoroutine(movement.ShnurRoute(eventData.pointerDrag.gameObject, 2));
                        }
                        else
                        {
                            eventData.pointerDrag.transform.position = eventData.pointerDrag.GetComponent<DragDropItem>().vector;
                    ...
                    break;
                case 6:
                    if (eventData.pointerDrag.GetComponent<SneakerScript>().state == 4)
                    {
                ...
                case 7:
                    ...
                    if (!eventData.pointerDrag.GetComponent<DragDropItem>().isHold)
                    {
                        if (list.Count != 0)
                        {
                            ...
                            eventData.pointerDrag.GetComponent<SneakerScript>().route = StartCoroutine(movement.WaitRoute(obj, 2));
                        }
                        list.Add(eventData.pointerDrag.gameObject);
                        eventData.pointerDrag.transform.position = movement.points[9].position;
                        eventData.pointerDrag.GetComponent<SneakerScript>().route = StartCoroutine(movement.WaitRoute(eventData.pointerDrag.gameObject, 1));
                ...
                case 8:
                    if (!eventData.pointerDrag.GetComponent<DragDropItem>().isHold)
                    {
                        if (eventData.pointerDrag.GetComponent<SneakerScript>().Id == 0 && eventData.pointerDrag.GetComponent<SneakerScript>().state == 1)
                        {
                            movement.total.text = (int.Parse(movement.total.text) + 1).ToString();
                            Destroy(eventData.pointerDrag.gameObject);
                        }
                ...
                case 9:
                    if (!eventData.pointerDrag.GetComponent<DragDropItem>().isHold)
                    {
                        if (eventData.pointerDrag.GetComponent<SneakerScript>().Id == 1 && eventData.pointerDrag.GetComponent<SneakerScript>().state == 1)
                        {
                            movement.total.text = (int.Parse(movement.total.text) + 1).ToString();
                            Destroy(eventData.pointerDrag.gameObject);
                        }
